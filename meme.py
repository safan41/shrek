...
def getMemeData(meme_page):
    ...
    try:
        photo = soup.find('a', attrs={'class':'photo left wide'}).attrs['href']
    except AttributeError:
        photo = soup.find('a', attrs={'class':'photo left '}).attrs['href']
    # имя, статус, и т.д.
    ...
    data_row = {"name":meme_name, "status":meme_status, 
                ...
                "about":meme_about, "origin":meme_origin, "other_text":other_text, "photo":photo}
    return data_row